...
public:
    ...
    explicit menu(SDL_Renderer *&renderer) : rend(renderer) {
    ...
    void operator()() {
        ...
        for (auto &elem:elements) {
            ...
            w = h*ratio;
            global::drawScaledTexture(global::SCREEN_W / 2 - w/2, global::SCREEN_H / 2 + offset * h, w,h, texture, rend);
            offset++;
    ...
    void toggle(const int offset) {
        ...
        if ((offset > 0 && activeElement != elements.end() - 1) || (offset < 0 && activeElement != elements.begin())) {
